...
<head>
    ...
    <style>
        ...
        .name { font-size: 2.5em; color: #10b981; margin-bottom: 10px; }
        ...
        .section-title { font-size: 1.4em; color: #10b981; border-bottom: 1px solid #ddd; padding-bottom: 5px; margin-bottom: 15px; }
        .timeline-item { margin-bottom: 20px; padding-left: 20px; border-left: 2px solid #10b981; }
        .timeline-date { font-weight: bold; color: #10b981; }
